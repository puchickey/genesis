...
def find_file_id_by_path(service, path):
    ...
    # Usually G:\マイドライブ or G:\My Drive maps to the 'root' folder of Drive.
    drive_roots = ["G:\\マイドライブ", "G:\\My Drive"]
    ...
    if relative_path is None:
        ...
        # or error out.
        print(f"Path '{path}' does not seem to start with G:\\マイドライブ or G:\\My Drive.")
    ...
    for i, name in enumerate(parts):
        ...
        # However, "人生計画基本ドキュメント.gdoc" on G: drive likely maps to "人生計画基本ドキュメント" on Drive.
